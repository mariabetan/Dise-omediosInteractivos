...
fondoP1=loadImage('data/polo.jpg');  
fondoV1=loadImage('data/pasto.jpg');
fondoM1=loadImage('data/coral.jpg');
...
function touchStarted() {
  ...
  if(dist(touch[0].x, touch[0].y,cortadores.x,cortadores.y)<10){
    cortadores.rebotar(); 
    puntaje++;
